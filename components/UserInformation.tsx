...
const UpdateInformation = ({ navigation }: { navigation: any }) => {
    ...
    useEffect (() => {
        const fetchUser = async () => {
            setIsLoading(true);
            try {
                const response = await fetch(`${process.env.REACT_APP_BFFURL}/auth/user/${getUserId()}`, {
                    method: 'GET',
                    headers: {
        ...
        const fetchCompany = async () => {
            try {
                const response = await fetch(`${process.env.REACT_APP_BFFURL}/company/${getEmail()}`, {
                    method: 'GET',
                    headers: {
                        'Content-Type': 'application/json',
                    },
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            if (response.ok) {
                const companyResponse = await fetch(`${process.env.REACT_APP_BFFURL}/company/byEmail/${getEmail()}`, {
                    method: 'PUT',
                    headers: {
                        'Content-Type': 'application/json',
                    },
